...
BOOL QueryDir(eHookPlayerType hookType, TCHAR* szBuffer)
{
	...
	case eHookPlayerType::ePlayer_KuGou:
		strFormat = _T("SOFTWARE\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\酷狗音乐"); break;
	case eHookPlayerType::ePlayer_CloudMusic:
		strFormat = _T("SOFTWARE\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\网易云音乐"); break;
